...
db.customers.insertMany([
    ...
    { 
        ...
        "phone": "555-5678", 
        "registration_date": ISODate("2023-02-02T08:30:00Z") 
    },
    { 
        "_id": ObjectId("unique_id3"), 
        "name": "Alice Johnson", 
        ...
        "phone": "555-7890", 
        "registration_date": ISODate("2023-03-03T14:45:00Z") 
    },
    { 
        "_id": ObjectId("unique_id4"), 
        "name": "Bob Williams", 
        ...
        "phone": "555-1011", 
        "registration_date": ISODate("2023-04-04T09:00:00Z") 
    },
    { 
        "_id": ObjectId("unique_id5"), 
        "name": "Charlie Brown", 
        ...
        "phone": "555-2022", 
        "registration_date": ISODate("2023-05-05T18:20:00Z") 
    }
]);
...
db.orders.insertMany([
    { 
        ...
        "order_id": "ORD123456", 
        "customer_id": ObjectId("unique_id1"), 
    ...
    { 
        ...
        "order_id": "ORD123457", 
        "customer_id": ObjectId("unique_id2"), 
        "order_date": ISODate("2023-05-16T10:00:00Z"), 
        "status": "delivered", 
        "items": [
            { 
    ...
    { 
        "_id": ObjectId("order_id3"), 
        "order_id": "ORD123458", 
        "customer_id": ObjectId("unique_id3"), 
        "order_date": ISODate("2023-05-17T11:00:00Z"), 
        "status": "pending", 
        "items": [
            { 
    ...
    { 
        "_id": ObjectId("order_id4"), 
        "order_id": "ORD123459", 
        "customer_id": ObjectId("unique_id4"), 
        "order_date": ISODate("2023-05-18T12:00:00Z"), 
        "status": "shipped", 
        "items": [
            { 
                "product_name": "Tablet", 
    ...
    { 
        "_id": ObjectId("order_id5"), 
        "order_id": "ORD123460", 
        "customer_id": ObjectId("unique_id5"), 
        "order_date": ISODate("2023-05-19T13:00:00Z"), 
        "status": "processing", 
        "items": [
            { 
